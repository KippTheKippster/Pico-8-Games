...
perm_pickup = pickup:new{}
perm_pickup.name = "pickup"
perm_pickup.desc = 
{
	"this is ",
	"a permanent pickup!"
}
perm_pickup.sound = 13
perm_pickup.permanent = true
...
maxhp_pickup = perm_pickup:new{}
maxhp_pickup.sprite = 116
maxhp_pickup.name = "health pickup"
maxhp_pickup.desc = 
{
	"your health has",
...
missile_block = entity:new{}
missile_block.sprite = 192
missile_block.w = 14
missile_block.h = 14
missile_block.visible = true
missile_block.tx = 0
missile_block.ty = 0

function missile_block:ready()
	self.tx = self.x/8
	self.ty = self.y/8
	mset(self.tx, self.ty, 192)
	self.x = self.x - 2
	self.y = self.y - 2
end

function missile_block:update()
	local c = self:getcoll("p_missile")
	if #c > 0 then
		self:destroy()
		c[1]:kill()
...
function ammo_ui:draw(x, y)
	spr(112,x+1,y+14)
	print("  " .. player.ammo .. "/" .. player.max_ammo , x + 2, y + 16, 0)
end

--popup
popup = control:new{}
popup:add()
popup.pausable = false
popup.visible = false

function show_pickup(o)
	popup:pickup(o)
end

function popup:pickup(o)
	self.visible = true
	update = false
	render = false
	popup_pickup:add()
...
popup_pickup = control:new{}
popup_pickup.pausable = false
popup_pickup.o = nil
popup_pickup.i = 1

function popup_pickup:draw(x,y)
	rectfill(x+16,y+16,x+112,y+112)
	for i = 1, #self.o.desc do
		print(self.o.desc[i],
		 x+center(self.o.desc[i]), y+48+8*i, 7)
	end
	
	print(self.o.name,
		 x+center(self.o.name), y+32, 7)
	...
	spr(self.o.sprite, x+64-(self.o.w/2), y+40)

	self.i = self.i + 1
	
	if self.i > 64 then
		local t = "press 🅾️ to continue"
		print(t, x + center(t), y+128-32)
		if btn(🅾️) then
			render = true
			update = true
			self:destroy()
...

...

...

...

...

__sfx__
...

